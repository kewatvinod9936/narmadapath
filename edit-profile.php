...
if(isset($_GET['edit'])){
    ...
    if(mysqli_num_rows($edit_query_run) > 0){
        ...
        if($e_username == $_session_username){
...
<?php require_once('inc/sidebar.php');?>       
        ...
        <div class="col-md-9">
        <h1><i class="fa fa-user-plus"></i> Edit Profile <small>NP Group Member</small></h1>            
        <ol class="breadcrumb">
          <li><a href="index.php"><i class="fa fa-tachometer"></i>  Dashboard</a></li>
          <li class="active"><i class="fa fa-users"></i> Edit Profile Details </li>
        </ol>
            ...
            if(isset($_POST['submit'])){
                ...
                $details = mysqli_real_escape_string($con, $_POST['details']);$password = mysqli_real_escape_string($con, $_POST['password']);
                ...
                if(empty($first_name) or empty($last_name) or empty($image)){
                    ...
                    $update_query = "UPDATE `users` SET `first_name` = '$first_name', `last_name` = '$last_name', `image` = '$image', `details` = '$details', `mob` = '$mob'";
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <input type="submit" value="Udate Profile" name="submit" class="btn btn-primary">
                </form>    
            </div>
