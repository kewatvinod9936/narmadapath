...
<?php require_once('inc/sidebar.php');?>               
        ...
        <div class="col-md-9">
        <h1><i class="fa fa-database"></i> Media <small>Add or Views Media Files</small></h1>            
        <ol class="breadcrumb">
       ...
       <form action="" method="post" enctype="multipart/form-data">
           <div class="row">
               ...
               <div class="col-sm-4 col-xs-4">
                   <input type="submit" class="btn btn-primary btn-sm" value="Add Media" name="submit">
               </div>
           </div>
       </form>
          ...
          <?php
           ...
           <div class="col-lg-2 col-md-3 col-sm-3 col-xs-6 thumb">
               <a href="media/<?php echo $get_image;?>" class="thumbnail">
                   <img src="media/<?php echo $get_image;?>" alt="" width="100%">
               </a>
           </div>
