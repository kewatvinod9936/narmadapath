...
<?php require_once('inc/sidebar.php');?>       
        ...
        <div class="col-md-9">
        <h1><i class="fa fa-comments"></i> Comments <small>Views All Comments</small></h1>            
        <ol class="breadcrumb">
...
<form action="" method="post">        
        ...
        <table class="table table-bordered table-striped table-hover" >
               ...
               <?php
                ...
                <tr>
                   <td><input type="checkbox" class="checkboxes" name="checkboxes[]" value="<?php echo $id;?>" ></td>
                    ...
                    <td><a href="comments.php?reply=<?php echo $post_id;?>"><i class="fa fa-reply-all"></i></a></td>
            ...
            <?php
                ...
                echo "<center><h2>No User Available</center></h2>";
            }
