...
<?php require_once('inc/sidebar.php');?>               
        ...
        <div class="col-md-9">
        <h1><i class="fa fa-folder-open"></i> Categories <small>All Category</small></h1>            
        <ol class="breadcrumb">
            ...
            <div class="col-md-6">
                <form action="" method="post" >
                    <div class="form-group">
                        <label for="categoy">Category Name</label>
                        <?php
                        if(isset($msg)){
                ...
                <form action="" method="post" >
                    <div class="form-group">
                        <label for="categoy">Update Category Name</label>
                        <?php
                        if(isset($up_msg)){
                    ...
                    <input type="submit" value="Udate Category" name="update" class="btn btn-primary"  >
                </form>
